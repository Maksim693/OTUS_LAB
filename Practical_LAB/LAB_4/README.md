...
- [Сслыка для скачивания итоговой конфигурация](https://github.com/Maksim693/OTUS_LAB/blob/main/Practical_LAB/LAB_4/LAB4_%D0%9F%D1%80%D0%BE%D0%B5%D0%BA%D1%82%D0%B8%D1%80%D0%BE%D0%B2%D0%B0%D0%BD%D0%B8%D0%B5_%D1%81%D0%B5%D1%82%D0%B8.zip)
------------
...
| 10.121.0.0/24 | С.-Петербург | PtP-Link (local) |
...
| 192.168.128.1/24 | Чокудах | Client (Vlan 60) |
| 192.168.129.1/24 | Чокудах | Client (Vlan 70) |
...
| R14 | e1/0 |  10.120.0.13 | 255.255.255.252 | PtP to R15 |
...
| R15 | e1/0 |  10.120.0.14 | 255.255.255.252 | PtP to R14 |
...
| MLSW5 | e1/0 | 10.120.0.38 | 255.255.255.252 | PtP to R13 |
| MLSW5 | e1/1 | 10.120.0.34 | 255.255.255.252 | PtP to R12 |
...
| R28 | e0/2.60 | 192.168.128.0 | 255.255.255.0 | VPC30_Vlan_60 |
| R28 | e0/2.70 | 192.168.129.0 | 255.255.255.0 | VPC31_Vlan_70 |
...
```
VPC> ip 192.168.0.4/24 192.168.0.1
VPC> wr
```
------------
...
| R28 | lo0 | 10.12.0.28 | 255.255.255.255 | - | Чокурдах |
| SW29 | MGMT_Vlan_1210 | 10.242.0.2 | 255.255.255.252 | 10.242.0.1 | Чокурдах |
| R27 | lo0 | 10.13.0.27 | 255.255.255.255 | - | Лабытнанги |
...
##### Пример настройки loopback интерфеса
```
R13#configure terminal
R13(config)#interface loopback 0
R13(config-if)#ip address 10.110.0.13 255.255.255.255
R13(config-if)#end
R13#write memory
```
------------

#### Cети офисов настроены так, чтобы не возникало broadcast штормов. Использование линков максимально оптимизировано. В работы был использован IPv4.
